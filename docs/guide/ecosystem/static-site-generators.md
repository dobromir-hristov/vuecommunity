...
[Vuepress](static-site-generators.md#vuepress) - uses markdown and Vue components to build docs, blogs and more

[Saber](static-site-generators.md#saber) - uses markdown, Vue components and JS files. Options for view layer.

[Nuxt](static-site-generators.md#nuxt-static-generated-mode) - statically pre-render any SSR compliant SPA, very flexible

[Gridsome](static-site-generators.md#gridsome) - static websites with flexible GraphQL data layer for any backend

[Prerender SPA Plugin](static-site-generators.md#prerender-spa-plugin) - low level prerendering plugin

[Poi + vue-static](static-site-generators.md#poi-+-vue-static) - leverage pre-rendering for each route at build time
...
NuxtPress is an addon for [Nuxt](static-site-generators.md#nuxt-static-generated-mode) (thus it also supports pre-rendering) which adds the ability to create Nuxt pages as `.md` files.
