...
<useful-links-section title="3rd party integrations">
Vue-i18n is sponsored and very well integrated by web service for managing translations - [localazy.com](https://localazy.com/). Use "kazupon" coupon or contact them for OSS support.
